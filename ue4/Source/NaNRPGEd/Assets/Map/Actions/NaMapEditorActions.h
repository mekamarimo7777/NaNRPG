 ...
 * 
 */
class FNaMapEditorCommands : public TCommands<FNaMapEditorCommands>
{

public:
	FNaMapEditorCommands() : TCommands<FNaMapEditorCommands>
	(
		"NaMapEditor", // Context name for fast lookup
		NSLOCTEXT("Contexts", "NaMapEditor", "NaMap Editor"), // Localized context name for displaying
