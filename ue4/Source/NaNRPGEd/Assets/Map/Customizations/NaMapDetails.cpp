...
//! 
TSharedRef<IDetailCustomization> FNaMapDetails::MakeInstance()
{
	return MakeShareable(new FNaMapDetails());
}

//! 
void FNaMapDetails::CustomizeDetails(class IDetailLayoutBuilder& DetailBuilder)
{
