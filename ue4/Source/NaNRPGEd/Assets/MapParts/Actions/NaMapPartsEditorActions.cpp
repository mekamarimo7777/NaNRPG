...
#include "NaMapPartsEditorActions.h"

#define LOCTEXT_NAMESPACE "NaNRPGEd"

void FNaMapPartsEditorCommands::RegisterCommands()
{
	//! 
	UI_COMMAND( SelectTierTool, "TierTool", "TierTool.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SelectMinecraftTool, "MCTool", "Tool like a Minecraft.", EUserInterfaceActionType::RadioButton, FInputChord() );

	UI_COMMAND( SetCrossSection, "CrossSection", "CrossSection", EUserInterfaceActionType::ToggleButton, FInputChord() );

	//! 
	UI_COMMAND( SelectDrawPenTool, "Pen", "PenTool.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SelectDrawBoxTool, "Box", "BoxTool.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SelectDrawFillTool, "Fill", "FillTool.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SelectSelectionTool, "Selection", "Selection.", EUserInterfaceActionType::RadioButton, FInputChord() );
